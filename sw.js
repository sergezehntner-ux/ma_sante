const CACHE='ma-sante-cache-v02003';
const CORE=['./index.html','./styles.css','./app.js','./manifest.webmanifest','./favicon.png','./apple-touch-icon.png','./icon-48.png','./icon-96.png','./icon-192.png','./icon-512.png'];
